...
link Sheet mein daala jata hai.
listing_id bhi pass kiya jata hai taaki Sheet mein duplicate-tracking ho sake.
"""
...
def run(approved_products):
    ...
    for i, product in enumerate(approved_products):
        try:
            listing_id = product.get("listing_id", i)
            filename = f"pin_{listing_id}.png"
